...
public class SiteFileFetch extends Thread {
	...
	public static boolean HttpDown(String url,String spath,String sname,int threadCount) throws IOException{
		System.out.println(url);
		System.out.println(spath);
		System.out.println(sname);
		SiteInfoBean bean = new SiteInfoBean(url, spath, sname, threadCount);
